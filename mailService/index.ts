...
async function main() {   
    const email_hostname = process.env.MAIL_HOSTNAME ?? "localhost";
    const email_username = process.env.MAIL_USERNAME ?? "username";
    const email_password = process.env.MAIL_PASSWORD ?? "password";
