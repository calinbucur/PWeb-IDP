namespace Petaway.Core.DataModel
{
    ...
    {
        public Rescuers(string userId, string email, string name, string phoneNumber, string address, int maxCapacity, string animalType = "all", string isAggresive = "all", string isSick = "all", string isStray = "all") : base(userId, email, name, phoneNumber, address)
        {
            CrtCapacity = 0;
